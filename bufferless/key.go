...
// CreateEventKey attempts to create a suitable event.  It parses the various
...
func CreateEventKey(k Key, ch rune, mod ModMask) EventKey {
	...
	return EventKey{key: k, ch: ch, mod: mod}
}
